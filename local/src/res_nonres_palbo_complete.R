...
#metadata_o_f <- "/mnt/trcanmed/snaketree/prj/RNASeq_biod_metadata/dataset/july2020_starOK/selected_metadata_annot_final_nolinfo_nooutlier"
...
meda_fin <- rbind(meda_fin, c("CRC1448", "2", "responder"))
rownames(meda_fin)[rownames(meda_fin) == "12"] <- "CRC1448"
meda_fin <- rbind(meda_fin, c("CRC1257", "2", "responder"))
rownames(meda_fin)[rownames(meda_fin) == "13"] <- "CRC1257"
