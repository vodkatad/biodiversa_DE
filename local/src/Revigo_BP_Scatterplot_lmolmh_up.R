...
p1 <- p1 + scale_size_continuous(breaks = c(0.95, 1.96, 3.0)) + theme_bw()
...
ggsave("revigo_lmo_lmh_up.pdf", width = 11.69, height = 8.27)
p1 <- p1 + unmute_theme
dev.off()
