...
#write.table(quartiles_krt, file = "/home/mferri/quartiles_krt_Ac.tsv", quote = FALSE, sep = "\t", col.names = TRUE, row.names = TRUE)
...
write.table(classification, file = "/home/mferri/only_Ac_Pd_high_low_krt.tsv", quote = FALSE, sep = "\t", col.names = TRUE, row.names = TRUE)
