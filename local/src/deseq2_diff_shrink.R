...
con2 <-  c(snakemake@params[["factor"]], snakemake@params[["den"]], 'vs', snakemake@params[["nom"]]) # why is it inverted?
print(paste0(con2, collapse="_"))
res <- lfcShrink(dds, coef=paste0(con2, collapse="_"), type=snakemake@wildcards[['type']])
