...
ggplot(data=forplot, aes(x=type, y=HALLMARK_IL6_JAK_STAT3_SIGNALING))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("HALLMARK_INTERFERON_ALPHA_RESPONSE.pdf")
ggplot(data=forplot, aes(x=type, y=HALLMARK_INTERFERON_ALPHA_RESPONSE))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("HALLMARK_INTERFERON_GAMMA_RESPONSE.pdf")
ggplot(data=forplot, aes(x=type, y=HALLMARK_INTERFERON_GAMMA_RESPONSE))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION.pdf")
ggplot(data=forplot, aes(x=type, y=HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("HALLMARK_FATTY_ACID_METABOLISM.pdf")
ggplot(data=forplot, aes(x=type, y=HALLMARK_FATTY_ACID_METABOLISM))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
...
ggplot(data=forplot, aes(x=type, y=REACTOME_FATTY_ACID_METABOLISM))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("LIN_APC_TARGETS.pdf")
ggplot(data=forplot, aes(x=type, y=LIN_APC_TARGETS))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("KIM_MYC_AMPLIFICATION_TARGETS_DN.pdf")
ggplot(data=forplot, aes(x=type, y=KIM_MYC_AMPLIFICATION_TARGETS_DN))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("SANSOM_APC_TARGETS_DN.pdf")
ggplot(data=forplot, aes(x=type, y=SANSOM_APC_TARGETS_DN))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
## c6
...
ggplot(data=forplot, aes(x=type, y=BCAT.100_UP.V1_UP))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("LEF1_UP.V1_UP.pdf")
ggplot(data=forplot, aes(x=type, y=LEF1_UP.V1_UP))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
pdf("LEF1_UP.V1_DN.pdf")
ggplot(data=forplot, aes(x=type, y=LEF1_UP.V1_DN))+geom_boxplot(aes(col = type))+geom_signif(comparisons = list(c("Resistant_3Q", "Sensitive_1Q")))+scale_color_manual(values = c("grey", rgb(165, 0, 25, maxColorValue = 255), rgb(30, 85, 130, maxColorValue = 255)))
dev.off()
