...
if (type == "H") {
  print("I will plot hallmark GSEA")
  blu <- c("HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION", 
           "HALLMARK_KRAS_SIGNALING_DN",
           "HALLMARK_KRAS_SIGNALING_UP",
           "HALLMARK_WNT_BETA_CATENIN_SIGNALING")
  color <- c("#E41A1C", "#4DAF4A", "#984EA3", "#FF7F00") 
} else {
  print("I will plot C2 GSEA")
  blu <- c("REACTOME_SIGNALING_BY_FGFR1",
...
p <- gseaplot2(em, geneSetID=wi, color = color, subplots = 1:2)
