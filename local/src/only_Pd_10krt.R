...
#write.table(merged2, file = "/home/mferri/AC_10_krt.tsv", quote = FALSE, sep = "\t", col.names = TRUE, row.names = TRUE)
...
final_eg <- data.frame(matrix(ncol = 10, nrow = 62))
...
write.table(classification, file = "/home/mferri/Pd_high_low_krt.tsv", quote = FALSE, sep = "\t", col.names = TRUE, row.names = TRUE)
write.table(final2, file = "/home/mferri/allchrts_Pd_high_low_krt.tsv", quote = FALSE, sep = "\t", col.names = TRUE, row.names = TRUE)
