...
ggsave("CC.pdf", width = 300, height = 300, useDingbats=FALSE, units = "mm")
barplot(egomf, showCategory = 20)
ggsave("MF.pdf",width = 300, height = 300, useDingbats=FALSE, units = "mm")
barplot(egobp, showCategory = 20)
ggsave("BP.pdf",width = 300, height = 300, useDingbats=FALSE, units = "mm")
