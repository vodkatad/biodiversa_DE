...
p1 <- p1 + scale_size_continuous(labels = c(0.60, 1.95, 3.0), breaks = c(3,5,8)) + theme_bw()
...
p1 <- p1 + unmute_theme
ggsave("revigo_lmx_lmh_up.pdf", width = 120, height = 107, useDingbats=FALSE, units = "mm")
p1
dev.off()
