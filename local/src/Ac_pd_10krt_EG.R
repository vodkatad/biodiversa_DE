...
connector2 <- connector2 %>% filter(col == "Ac")
...
write.table(merged2, file = "/home/mferri/AC_PD_10_krt.tsv", quote = FALSE, sep = "\t", col.names = TRUE, row.names = TRUE)
...
final_eg <- data.frame(matrix(ncol = 10, nrow = 18))
