##Read files named
filenames <- list.files(path="/mnt/cold1/snaketree/prj/DE_RNASeq/dataset/TCF7L2_2nd/assays/GSEA_H_b2/",
                        pattern="*.tsv")
...
###Load all files
for(i in names){
  filepath <- file.path("/mnt/cold1/snaketree/prj/DE_RNASeq/dataset/TCF7L2_2nd/assays/GSEA_H_b2/",paste("GSEA_results_sh_", i,"_H_geno_cutoff0.05-scr.vs.b2.tsv",sep=""))
